namespace ChatRoom.Forms
{
	partial class ClientWindow
	{
		...
		private void InitializeComponent()
		{
			...
			// startMenuItem
			// 
			startMenuItem.DropDownItems.AddRange(new ToolStripItem[] { serverConfigMenuItem, connectMenuItem, disconnectMenuItem });
			...
			// 
			serverConfigMenuItem.Name = "serverConfigMenuItem";
			serverConfigMenuItem.Size = new Size(189, 26);
			serverConfigMenuItem.Text = "服务器配置(O)";
			serverConfigMenuItem.Click += OnConfigItemClick;
			// 
			// connectMenuItem
			// 
			connectMenuItem.Name = "connectMenuItem";
			connectMenuItem.Size = new Size(189, 26);
			connectMenuItem.Text = "连接服务器(C)";
			connectMenuItem.Click += OnConnectItemClick;
			// 
			// disconnectMenuItem
			// 
			disconnectMenuItem.Enabled = false;
			disconnectMenuItem.Name = "disconnectMenuItem";
			disconnectMenuItem.Size = new Size(189, 26);
			disconnectMenuItem.Text = "断开服务器(D)";
			disconnectMenuItem.Click += OnDisconnectItemClick;
			// 
			// helpMenuItem
			// 
			...
			aboutMenuItem.Click += OnAboutItemClick;
			// 
			// exitMenuItem
			// 
			...
			exitMenuItem.Click += OnExitItemClick;
			// 
			// mainLayout
			// 
			...
			mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
			mainLayout.Size = new Size(800, 538);
			...
			receiveGroupBox.Size = new Size(782, 257);
			...
			receiveTextBox.Location = new Point(6, 26);
			...
			receiveTextBox.Size = new Size(770, 223);
			...
			sendGroupBox.Location = new Point(9, 272);
			sendGroupBox.Name = "sendGroupBox";
			sendGroupBox.Size = new Size(782, 257);
			...
			sendButton.Location = new Point(663, 33);
			...
			nameInputBox.Location = new Point(82, 34);
			...
			usernameLabel.Location = new Point(24, 37);
			usernameLabel.Name = "usernameLabel";
			usernameLabel.Size = new Size(39, 20);
		...
		private ToolStripMenuItem serverConfigMenuItem;
